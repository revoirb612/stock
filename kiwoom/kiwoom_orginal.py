...
class Kiwoom(QAxWidget):
    ...
    def real_event_slot(self):
        print('real_event_slot() start')
        self.OnReceiveRealData.connect(self.real_data_slot)  # 실시간 이벤트 연결
    ...
    def get_code_list_by_market(self, market_code):
        print('get_code_list_by_market() start')
    ...
    def day_kiwoom_db(self, code=None, date=None, sPrevNext="0"):
        ...
        self.dynamicCall("CommRqData(QString, QString, int, QString)",
                         "주식일봉차트조회", "opt10081", sPrevNext, self.screen_calculation_stock)  # Tr서버로 전송 -Transaction
    ...
    def read_code(self):
        ...
        if os.path.exists("files/condition_stock.txt"):  # 해당 경로에 파일이 있는지 체크한다.
            ...
            for line in lines:  # 줄바꿈된 내용들이 한줄씩 읽어와진다.
                if line != "":
                    ls = line.split("\t")
